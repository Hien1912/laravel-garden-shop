                        ...
                        <div class="card">
                            <section>
                                <div class="modal fade top" id="frameModalTopInfoDemo" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-frame modal-top modal-notify modal-info"
                                        role="document">
                                ...
                                <div class="modal fade bottom" id="frameModalBottomSuccessDemo" tabindex="-1"
                                ...
                                <div class="modal fade right" id="fluidModalRightSuccessDemo" tabindex="-1"
                                    role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
                                    data-backdrop="false">
                                ...
                                <div class="modal fade left" id="dashboarhview" tabindex="-1" role="dialog"
                                    aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
                                ...
                                <div class="modal fade bottom" id="fluidModalBottomDangerDemo" tabindex="-1"
                                    role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
                                    data-backdrop="false">
    ...
    <script src="../test/js/mdb.min.js"></script>
</body>
