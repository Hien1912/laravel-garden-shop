<div class="card">
    ...
    <div class="card-body" id="pot">
        <table class="table table-striped" id="table_pot">
            ...
            <tbody>
                @foreach ($orders->where('status', 'cancelled') as $stt => $order)
                <tr>
                    <td>{{ ++$stt }}</td>
                    ...
                    <td class="text-center">
                        <button type="button" data-url="{{ route('order.show', $order) }}"
                        ...
                        <button type="button" data-id="{{ $order->id }}" data-btn="pot"
